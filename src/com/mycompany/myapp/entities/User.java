...
public class User {
    ...
    public User(int id, String mail_utilisateur, String sudo_utilisateur, String nom_utilisateur, String prenom_utilisateur, String password) {
        this.id = id;
    ...
    public User(String mail_utilisateur, String sudo_utilisateur, String nom_utilisateur, String prenom_utilisateur, String password) {
        this.mail_utilisateur = mail_utilisateur;
        this.sudo_utilisateur = sudo_utilisateur;
        this.nom_utilisateur = nom_utilisateur;
        this.prenom_utilisateur = prenom_utilisateur;
    ...
    public User(int id, String nom_utilisateur, String prenom_utilisateur, String mail_utilisateur) {
        this.id = id;
        this.nom_utilisateur = nom_utilisateur;
        this.prenom_utilisateur = prenom_utilisateur;
        this.mail_utilisateur = mail_utilisateur;
    ...
    public User(int id, String mail_utilisateur, String sudo_utilisateur, String nom_utilisateur, String prenom_utilisateur, String password, String Numero_utilisateur) {
        this.id = id;
        this.mail_utilisateur = mail_utilisateur;
        this.sudo_utilisateur = sudo_utilisateur;
        this.nom_utilisateur = nom_utilisateur;
    ...
    public User(String mail_utilisateur, String sudo_utilisateur, String nom_utilisateur, String prenom_utilisateur, String adresse_utilisateur, String password, String Numero_utilisateur) {
        this.mail_utilisateur = mail_utilisateur;
        this.sudo_utilisateur = sudo_utilisateur;
        this.nom_utilisateur = nom_utilisateur;
        this.prenom_utilisateur = prenom_utilisateur;
    ...
    public String toString() {
        return "User{" + "id=" + id + ", mail_utilisateur=" + mail_utilisateur + ", sudo_utilisateur=" + sudo_utilisateur + ", nom_utilisateur=" + nom_utilisateur + ", prenom_utilisateur=" + prenom_utilisateur + ", adresse_utilisateur=" + adresse_utilisateur + ", password=" + password + ", Numero_utilisateur=" + Numero_utilisateur + ", Role=" + Role + ", isExpired=" + isExpired + ", isVerified=" + isVerified + '}';
    }
