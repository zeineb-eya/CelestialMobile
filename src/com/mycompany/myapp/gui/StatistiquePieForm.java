...
BaseForm form;
       ...
       /* RadioButton popular = RadioButton.createToggle("Categorie ", barGroup);
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, all,profile),
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutReclamForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
