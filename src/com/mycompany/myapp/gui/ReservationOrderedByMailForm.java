 ...
 * @author HP
 */
public class ReservationOrderedByMailForm extends Form{
    Form current;
    ServiceReservation ServiceReservation = new ServiceReservation();
    ArrayList<Reservation> ReservationArrayList = new ArrayList<>();
    public ReservationOrderedByMailForm(Form previous) {
//        
current = this;
        setTitle("Planning List");
        setLayout(BoxLayout.y());

        ReservationArrayList = ServiceReservation.showOrderedByMail();
