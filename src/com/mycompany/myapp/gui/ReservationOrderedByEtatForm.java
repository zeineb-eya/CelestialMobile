 ...
 * @author HP
 */
public class ReservationOrderedByEtatForm extends Form{
    Form current;
    ServiceReservation ServiceReservation = new ServiceReservation();
    ArrayList<Reservation> ReservationArrayList = new ArrayList<>();
    public ReservationOrderedByEtatForm(Form previous) {
//        
current = this;
        setTitle("Planning List");
        setLayout(BoxLayout.y());

        ReservationArrayList = ServiceReservation.showOrderedByEtat();

              
        for (Reservation reservation : ReservationArrayList) {
            MultiButton multiButton = new MultiButton();
            multiButton.setTextLine1(reservation.getEtatReservation());
            multiButton.setTextLine2(reservation.getDateReservation());
