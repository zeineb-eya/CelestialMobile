...
public class ListCategory extends Form{
    Form current;
     public ListCategory (Form current) {
    ...
    public Form createForm() {
        ...
        Label labelnom= new Label("Nom Categorie");
        
       
        
        //Label labelEdit = new Label("Delete");
        //Label labelDelete = new Label("Edit");
...
//                 e -> new HomeReview());
        ...
        ArrayList<CategorieEquipement> Equipements = ServiceCategory.getInstance().getAllTasks();
        for (CategorieEquipement eq : Equipements) {
            //delete button
            ...
            lSupprimer.addPointerPressedListener(l -> {
                ...
                if (dig.show("Suppression", "Voulez vous supprimer l' Equipement ?", "Annuler", "OK")) {
                    dig.dispose();
                } else {
                    dig.dispose();
                }
                ...
                if (ServiceEquipment.getInstance().Delete(eq)) {
           ...
           /* Label lCancel = new Label(" ");
            ...
            BodyConainter.add(new Label(String.valueOf(eq.getId())));
            
       
  
           
            BodyConainter.add(new Label(String.valueOf(eq.getNom_categorie_equipement())));
       ...
       Comment.addActionListener(e -> new AddCategory());
        tempForm.show();
