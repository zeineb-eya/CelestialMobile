...
public class HomePlaninngForm extends Form{
    ...
    // current=this; //Back
     ...
     btnAddPlaninng.addActionListener(e-> new AjoutPlaninngForm().show());
      ...
      Button btnlistPlanByPrix = new Button("Planinngs");
    
         btnlistPlanByPrix.addActionListener(e-> new listPlanByPrix().show());
          
      addAll(btnAddPlaninng,btnListPlaninngs,btnlistPlanByPrix);
