 ...
 * @author 21628
 */
public class ListEquipmentt extends Form{
    Form current;
     public ListEquipmentt (Form current) {
...
//                 e -> new HomeReview());
        ...
        ArrayList<Equipement> Equipements = ServiceEquipment.getInstance().getAllEquipments();
