 ...
 * @author HP
 */
public class StatistiquePieReservationForm extends Form {
    private boolean drawOnMutableImage;
   
    
    private double nbr_billet = 45;
    private double nbr_reservation = 29;
   
    Form current;

        public StatistiquePieReservationForm(Resources res)  {
...
//        tb.addSearchCommand(e -> {});
        ...
        bindButtonSelection(profile, arrow);
                profile.addActionListener((e)->{
                  new StatistiquePieReservationForm(res).show();
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AddBilletForm(/*Resources.getGlobalResources()*/).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_billet + nbr_reservation;
        
        //values
        double prcntFeed = (nbr_billet *100)/total;
        
        double prcntRec = (nbr_reservation * 100)/total;
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Reservation",prcntRec);
        series.add("Billet",prcntFeed);
